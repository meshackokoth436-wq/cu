...
-- Add events.status when it does not already exist
...
-- Add events.capacity when it does not already exist
...
-- Add events.registration_deadline when it does not already exist
...
-- Add public schedule index when it does not already exist
...
-- Add location/date index when it does not already exist
